...
public class SimpleTurtle
{
  ...
  public void star(double sides, int size){
    for(int i=0; i<sides; i++){
      this.forward(size);
      this.turn(360-360/sides);
      this.forward(size);
      this.turn(720/sides);
    }
  }

  public void smiley(int penThickness, int size){
    this.setHeading(0);
    this.penDown();
    this.setPenWidth(penThickness);
    this.forward(size);
    this.penUp();
    this.xPos = this.getXPos()+size*2;
    this.turn(180);
    this.penDown();
    this.forward(size);
    this.penUp();
    this.xPos = this.getXPos()+size/2;
    this.yPos = this.getYPos()+size/2;
    this.turn(60);
    this.penDown();
    this.forward(size);
    this.turn(30);
